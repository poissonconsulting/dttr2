...
#' @describeIn dtt_day Get numeric vector of decimal year values for a Date vector
#' @export
dtt_day_decimal.Date <- function(x, ...) {
  as.numeric(dtt_day(x))
}

#' @describeIn dtt_day Get numeric vector of decimal year values for a POSIXct vector
#' @export
