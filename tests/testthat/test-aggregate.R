...
test_that("aggregate.Date", {
  ...
  expect_identical(dtt_aggregate(as.Date(c("1991-02-02", "1991-03-03")), "years"),
                   as.Date("1991-01-01"))
  expect_identical(dtt_aggregate(as.Date(c("1992-01-01", "1991-02-02", "1991-03-03")), "years"),
                   as.Date(c("1992-01-01", "1991-01-01")))
  expect_identical(dtt_aggregate(as.Date(c("1992-01-01", "1991-02-02", NA_Date_)), "years"),
                   as.Date(c("1992-01-01", "1991-01-01", NA_Date_)))
  expect_identical(dtt_aggregate(as.Date(c(NA, "1992-01-01", "1991-02-02")), "years"),
                   c(NA_Date_, as.Date(c("1992-01-01", "1991-01-01"))))
  expect_identical(dtt_aggregate(as.Date(c(NA, "1992-01-01", NA, "1991-02-02")), "years"),
                   c(NA_Date_, as.Date(c("1992-01-01", "1991-01-01"))))
})
...
test_that("aggregate.POSIXct", {
  ...
  expect_identical(dtt_aggregate(as.POSIXct("1969-01-01 23:59:59", tz = "UTC")), 
                   as.POSIXct("1969-01-01 23:59:59", tz = "UTC"))
  expect_identical(dtt_aggregate(as.POSIXct("1969-01-01 23:59:59", tz = "UTC"), "minutes"), 
                   as.POSIXct("1969-01-01 23:59:00", tz = "UTC"))
  expect_identical(dtt_aggregate(as.POSIXct("1969-01-01 23:59:59", tz = "UTC"), "hours"), 
