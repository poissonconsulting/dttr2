...
test_that("dtt_hour_decimal.POSIXct", {
  ...
  expect_identical(dtt_hour_decimal(as.POSIXct("2001-01-01 02:03:31", tz = "UTC")), 2.05)
  expect_equal(
    dtt_hour_decimal(as.POSIXct(c("2001-01-01 05:04:31", "2001-01-02 00:01:33"), tz = "UTC")),
    c(5.06666666666667, 0.0166666666666667)
  )
  expect_equal(
    dtt_hour_decimal(c(as.POSIXct("2001-01-01 23:32:31", tz = "UTC"), NA_POSIXct_)),
    c(23.5333333333333, NA)
  )
  expect_identical(dtt_hour_decimal(as.POSIXct("2001-01-01 16:06:31", tz = "Etc/GMT+8")), 16.1)
})
...
test_that("dtt_hour_decimal.hms", {
  ...
  expect_identical(dtt_hour_decimal(hms::as_hms(1)), 0)
  expect_equal(dtt_hour_decimal(hms::as_hms(-1)), 23.9833333333333)
  expect_equal(dtt_hour_decimal(hms::as_hms("20:30:32")), 20.5)
  expect_equal(dtt_hour_decimal(hms::as_hms(-3601)), 22.9833333333333)
