test_that("add_years.Date", {
  ...
  print("line10")
  print(names(as.Date(c("2002-01-01", "2004-01-01"))))
  print(names(dtt_add_years(as.Date(c("2000-01-01", "2002-01-01")))))
  ...
  expect_identical(
    dtt_add_years(c(as.Date("2002-01-01"), NA), 3L),
...
test_that("add_years.POSIXct", {
  ...
  expect_identical(
    dtt_add_years(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_years(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2002-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_years(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2L),
    as.POSIXct(c("2002-01-01", "2004-01-01"), tz = "UTC")
  )

  expect_identical(
    dtt_add_years(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2002-01-01", "2005-01-01"), tz = "UTC")
  )

  expect_identical(
    dtt_add_years(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2005-01-01", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_years(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_months.Date", {
  ...
  expect_identical(
    dtt_add_months(as.Date(c("2000-01-01", "2002-01-01")), 2:3),
    as.Date(c("2000-03-01", "2002-04-01"))
  )

  expect_identical(
    dtt_add_months(c(as.Date("2002-01-01"), NA), 3L),
...
test_that("add_months.POSIXct", {
  ...
  expect_identical(
    dtt_add_months(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_months(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2000-03-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_months(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2L),
    as.POSIXct(c("2000-03-01", "2002-03-01"), tz = "UTC")
  )

  expect_identical(
    dtt_add_months(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2000-03-01", "2002-04-01"), tz = "UTC")
  )

  expect_identical(
    dtt_add_months(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2002-04-01", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_months(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_days.Date", {
  ...
  expect_identical(
    dtt_add_days(as.Date(c("2000-01-01", "2002-01-02")), 2:3),
    as.Date(c("2000-01-03", "2002-01-05"))
  )

  expect_identical(
    dtt_add_days(c(as.Date("2002-01-01"), NA), 3L),
...
test_that("add_days.POSIXct", {
  ...
  expect_identical(
    dtt_add_days(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_days(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2000-01-03", tz = "UTC")
  )
  expect_identical(
    dtt_add_days(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L),
    as.POSIXct(c("2000-01-03", "2002-01-04"), tz = "UTC")
  )

  expect_identical(
    dtt_add_days(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2000-01-03", "2002-01-04"), tz = "UTC")
  )

  expect_identical(
    dtt_add_days(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2002-01-04", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_days(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_hours.POSIXct", {
  ...
  expect_identical(
    dtt_add_hours(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_hours(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2000-01-01 02:00:00", tz = "UTC")
  )
  expect_identical(
    dtt_add_hours(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L),
    as.POSIXct(c("2000-01-01 02:00:00", "2002-01-02 02:00:00"), tz = "UTC")
  )

  expect_identical(
    dtt_add_hours(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2000-01-01 02:00:00", "2002-01-01 03:00:00"), tz = "UTC")
  )

  expect_identical(
    dtt_add_hours(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2002-01-01 03:00:00", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_hours(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_hours.hms", {
  ...
  expect_identical(
    dtt_add_hours(hms::as_hms("00:00:00"), 0L),
    hms::as_hms("00:00:00")
  )
  expect_identical(
    dtt_add_hours(hms::as_hms("00:00:00"), 2L),
    hms::as_hms("02:00:00")
  )
  expect_identical(
    dtt_add_hours(hms::as_hms(c("00:00:00", "00:00:00")), 2L),
    hms::as_hms(c("02:00:00", "02:00:00"))
  )

  expect_identical(
    dtt_add_hours(hms::as_hms(c("00:00:00", "00:00:00")), 2:3),
    hms::as_hms(c("02:00:00", "03:00:00"))
  )

  expect_identical(
    dtt_add_hours(c(hms::as_hms("00:00:00"), NA), 2:3),
    c(hms::as_hms("02:00:00"), NA)
  )

  expect_identical(
    dtt_add_hours(c(hms::as_hms("00:00:00"), NA), 3L),
...
test_that("add_minutes.POSIXct", {
  ...
  expect_identical(
    dtt_add_minutes(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_minutes(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2000-01-01 00:02:00", tz = "UTC")
  )
  expect_identical(
    dtt_add_minutes(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L),
    as.POSIXct(c("2000-01-01 00:02:00", "2002-01-02 00:02:00"), tz = "UTC")
  )

  expect_identical(
    dtt_add_minutes(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2000-01-01 00:02:00", "2002-01-01 00:03:00"), tz = "UTC")
  )

  expect_identical(
    dtt_add_minutes(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2002-01-01 00:03:00", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_minutes(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_minutes.hms", {
  ...
  expect_identical(
    dtt_add_minutes(hms::as_hms("00:00:00"), 0L),
    hms::as_hms("00:00:00")
  )
  expect_identical(
    dtt_add_minutes(hms::as_hms("00:00:00"), 2L),
    hms::as_hms("00:02:00")
  )
  expect_identical(
    dtt_add_minutes(hms::as_hms(c("00:00:00", "00:00:00")), 2L),
    hms::as_hms(c("00:02:00", "00:02:00"))
  )

  expect_identical(
    dtt_add_minutes(hms::as_hms(c("00:00:00", "00:00:00")), 2:3),
    hms::as_hms(c("00:02:00", "00:03:00"))
  )

  expect_identical(
    dtt_add_minutes(c(hms::as_hms("00:00:00"), NA), 2:3),
    c(hms::as_hms("00:02:00"), NA)
  )

  expect_identical(
    dtt_add_minutes(c(hms::as_hms("00:00:00"), NA), 3L),
...
test_that("add_seconds.POSIXct", {
  ...
  expect_identical(
    dtt_add_seconds(as.POSIXct("2000-01-01", tz = "UTC"), 0L),
    as.POSIXct("2000-01-01", tz = "UTC")
  )
  expect_identical(
    dtt_add_seconds(as.POSIXct("2000-01-01", tz = "UTC"), 2L),
    as.POSIXct("2000-01-01 00:00:02", tz = "UTC")
  )
  expect_identical(
    dtt_add_seconds(as.POSIXct(c("2000-01-01", "2002-01-02"), tz = "UTC"), 2L),
    as.POSIXct(c("2000-01-01 00:00:02", "2002-01-02 00:00:02"), tz = "UTC")
  )

  expect_identical(
    dtt_add_seconds(as.POSIXct(c("2000-01-01", "2002-01-01"), tz = "UTC"), 2:3),
    as.POSIXct(c("2000-01-01 00:00:02", "2002-01-01 00:00:03"), tz = "UTC")
  )

  expect_identical(
    dtt_add_seconds(c(as.POSIXct("2002-01-01", tz = "UTC"), NA), 3L),
    c(as.POSIXct("2002-01-01 00:00:03", tz = "UTC"), NA)
  )
  expect_identical(
    dtt_add_seconds(c(as.POSIXct("2002-01-01", tz = "Etc/GMT+8"), NA), -3L),
...
test_that("add_seconds.hms", {
  ...
  expect_identical(
    dtt_add_seconds(hms::as_hms("00:00:00"), 0L),
    hms::as_hms("00:00:00")
  )
  expect_identical(
    dtt_add_seconds(hms::as_hms("00:00:00"), 2L),
    hms::as_hms("00:00:02")
  )
  expect_identical(
    dtt_add_seconds(hms::as_hms(c("00:00:00", "00:00:00")), 2L),
    hms::as_hms(c("00:00:02", "00:00:02"))
  )

  expect_identical(
    dtt_add_seconds(hms::as_hms(c("00:00:00", "00:00:00")), 2:3),
    hms::as_hms(c("00:00:02", "00:00:03"))
  )

  expect_identical(
    dtt_add_seconds(c(hms::as_hms("00:00:00"), NA), 2:3),
    c(hms::as_hms("00:00:02"), NA)
  )

  expect_identical(
    dtt_add_seconds(c(hms::as_hms("00:00:00"), NA), 3L),
