...
test_that("floored", {
  ...
  expect_true(dtt_floored(hms::as.hms("01:02:00"), "seconds"))
  expect_true(dtt_floored(hms::as.hms("01:20:00"), "minutes"))
  expect_false(dtt_floored(hms::as.hms("01:00:10"), "minutes"))
