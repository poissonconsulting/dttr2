...
test_that("dtt_month.POSIXct", {
  ...
  expect_identical(dtt_month(as.POSIXct(c("2001-04-01 05:06:31", "2001-06-05 00:01:33"), tz = "UTC")), 
                   c(4L, 6L))
  expect_identical(dtt_month(c(as.POSIXct("2001-07-01 23:32:31", tz = "UTC"), NA_POSIXct_)),
                   c(7L, NA_integer_))
...
test_that("dtt_month<-.POSIXct", {
  ...
  expect_identical(dtt_set_month(x, 10L), 
