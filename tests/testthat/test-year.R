...
test_that("dtt_year.POSIXct", {
  ...
  expect_identical(dtt_year(as.POSIXct(c("2004-04-01 05:06:31", "2005-06-05 00:01:33"), tz = "UTC")), 
                   c(2004L, 2005L))
  expect_identical(dtt_year(c(as.POSIXct("2008-07-01 23:32:31", tz = "UTC"), NA_POSIXct_)),
                   c(2008L, NA_integer_))
