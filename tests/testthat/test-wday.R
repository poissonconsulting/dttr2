test_that("wday for Dates", {
  ...
  expect_identical(dtt_wday(as.Date("2020-03-05") + 0:6), 
                   c("Thursday", "Friday", "Saturday", "Sunday", "Monday", "Tuesday", 
"Wednesday"))
    expect_identical(dtt_wday(as.Date("2020-03-05") + 0:6, abbr = TRUE), 
...
test_that("wday for POSIXct", {
  ...
  expect_identical(dtt_wday(as.POSIXct("2020-03-05") + 0:6 * 86400), 
                   c("Thursday", "Friday", "Saturday", "Sunday", "Monday", "Tuesday", 
"Wednesday"))
    expect_identical(dtt_wday(as.POSIXct("2020-03-05") + 0:6 * 86400, abbr = TRUE), 
                   c("Thu", "Fri", "Sat", "Sun", "Mon", "Tue", "Wed"))
})
