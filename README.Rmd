...
`dttr2` (Dates, Times and a TimeR) is an R package to manipulate date (Date), datetime (POSIXct) and time (hms) vectors which it collectively refers to as date/time vectors.
...
`dttr2` floors any date/time objects it encounters to the nearest time unit (days for Date and seconds for POSIXct and hms).
